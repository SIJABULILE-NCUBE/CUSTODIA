...
export default function Login() {
  ...
  return (
    <div className="mx-auto max-w-md px-6 py-16">
      <h1 className="font-hero text-3xl text-charcoal">Welcome back</h1>
      <p className="mt-2 text-sm text-charcoal/70">Log in to manage your bookings and programmes.</p>
